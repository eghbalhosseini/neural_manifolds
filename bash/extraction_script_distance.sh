...
singularity exec -B /om:/om,/mindhive:/mindhive /om/user/`whoami`/simg_images/neural_manifolds_tiny.simg python /om/user/`whoami`/neural_manifolds/extract_data_mock.py ${run_file} ${run_model_line} ${run_model} ${run_analyze} ${OVERWRITE}