...
runKNN('root_dir','$ROOT_DIR','analyze_identifier','$ANALYZE_ID','model_identifier','$MODEL_ID','training_folder','$TRAINING_FOLDER','extraction_identifier','$EXTRACTION_ID','layer','$LAYER','dist_metric','$DIST_METRIC','k',$NUM_K,'num_subsamples',$NUM_SUBSAMPLES);\
quit;"
