...
singularity exec --nv -B /om:/om /om/user/`whoami`/simg_images/neural_manifolds.simg python ~/MyCodes/neural_manifolds/run_mftma_on_synthetic_data.py "${dataset_list[$SLURM_ARRAY_TASK_ID]}"
