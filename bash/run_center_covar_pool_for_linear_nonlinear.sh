...
ANALYSIS_DIR=/nese/mit/group/evlab/projects/Greta_Eghbal_manifolds/analyze/
...
singularity exec -B /om:/om,/mindhive:/mindhive /om/user/${USER}/simg_images/neural_manifolds_tiny.simg python /om/user/${USER}/neural_manifolds/center_covar_pool_results.py ${model_list[$SLURM_ARRAY_TASK_ID]} ${analyze_mftma} ${train_dir_list[$SLURM_ARRAY_TASK_ID]}
