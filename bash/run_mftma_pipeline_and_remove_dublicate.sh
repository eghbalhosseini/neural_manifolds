      ...
      for net in NN ; do
        for idx in 0 ; do
          ...
          while read x; do
              ...
              original='Input_extracted_v3.pkl'
              correction='_mftma_analysis_v3_nrep_50.pkl'
...
if [ "$LINE_COUNT" -gt "$run_val" ]; then
   #nohup /cm/shared/admin/bin/submit-many-jobs $LINE_COUNT 500 600 100 mftma_script.sh $GRAND_MFTMA_FILE &
