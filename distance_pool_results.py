...
if __name__ == '__main__':
    ...
    distance_files=[]
    for file in os.listdir(os.path.join(save_dir,model_identifier_for_saving,train_dir_identifier)):
        if fnmatch.fnmatch(file, '*distance_data.pkl'):
            distance_files.append(os.path.join(save_dir,model_identifier_for_saving,train_dir_identifier,file))
    ...
    pool_file = os.path.join(save_dir, model_identifier_for_saving,train_dir_identifier, f'{model_identifier_for_saving}_distance_pooled.pkl')
