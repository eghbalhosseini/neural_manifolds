...
prctileNN = prctile(NNids,[5,25,50,75,95],2);
...
hier_struct = struct('productionTime',productionTime,...
                    'epoch',epoch,...
                    'epochLoc',epochLoc,...
                    'relTime',relTime,...
