...
if __name__ == '__main__':
    ...
    for file in os.listdir(os.path.join(analyze_dir, analyze_identifier_for_saving,model_identifier_for_saving,train_dir_identifier)):
        if fnmatch.fnmatch(file, '*_mftma_analysis_v3_nrep_250.pkl'):
    ...
    pool_file = os.path.join(analyze_dir,analyze_identifier, model_identifier_for_saving,train_dir_identifier, f'{model_identifier_for_saving}_mftma_pooled_v3_nrep_250.pkl')
